...
const Sidebar = () => {
  ...
  return (
    <div className="shadow-md m-2 w-70">
      <ul>
        <li className="flex m-4 hover:bg-gray-200 p-2 rounded-lg cursor-pointer">
          ...
          />
          <span className="my-auto ml-2 font-bold"> Home </span>
        </li>
<li className="flex m-4 hover:bg-gray-200 p-2 rounded-lg cursor-pointer">
          <img
            width="30"
          ...
          />
          <span className="my-auto ml-2 font-bold"> Shorts </span>
        </li>
<li className="flex m-4 hover:bg-gray-200 p-2 rounded-lg cursor-pointer">
          <img
            width="30"
          ...
          />
          <span className="my-auto ml-2 font-bold"> Subscriptions </span>
        </li>
      </ul>
...
<li className="flex m-4 hover:bg-gray-200 p-2 rounded-lg cursor-pointer">
          ...
          />
          <span className="my-auto ml-2 font-bold"> Library </span>
        </li>
<li className="flex m-4 hover:bg-gray-200 p-2 rounded-lg cursor-pointer">
          <img
            width="30"
          ...
          />
          <span className="my-auto ml-2 font-bold"> History </span>
        </li>
<li className="flex m-4 hover:bg-gray-200 p-2 rounded-lg cursor-pointer">
          <img
            width="30"
          ...
          />
          <span className="my-auto ml-2 font-bold"> Your videos </span>
        </li>
<li className="flex m-4 hover:bg-gray-200 p-2 rounded-lg cursor-pointer">
          <img
            width="35"
          ...
          />
          <span className="my-auto ml-2 font-bold"> Watch later </span>
        </li>
<li className="flex m-4 hover:bg-gray-200 p-2 rounded-lg cursor-pointer">
          <img
            width="30"
          ...
          />
          <span className="my-auto ml-2 font-bold"> Liked videos </span>
        </li>
<li className="flex m-4 hover:bg-gray-200 p-2 rounded-lg cursor-pointer">
          <img
            width="30"
          ...
          />
          <span className="my-auto ml-2 font-bold"> Show more </span>
        </li>
      </ul>
      <div className="border border-gray-200 w-100 mx-4"></div>
...
<li className="flex m-4 hover:bg-gray-200 p-2 rounded-lg cursor-pointer">
          ...
          />
          <span className="my-auto ml-2 font-bold"> Trending </span>
        </li>
<li className="flex m-4 hover:bg-gray-200 p-2 rounded-lg cursor-pointer">
          <img
            width="30"
          ...
          />
          <span className="my-auto ml-2 font-bold"> Shopping </span>
        </li>
<li className="flex m-4 hover:bg-gray-200 p-2 rounded-lg cursor-pointer">
          <img
            width="30"
          ...
          />
          <span className="my-auto ml-2 font-bold"> Music </span>
        </li>
<li className="flex m-4 hover:bg-gray-200 p-2 rounded-lg cursor-pointer">
          <img
            width="30"
          ...
          />
          <span className="my-auto ml-2 font-bold"> Movies </span>
        </li>
<li className="flex m-4 hover:bg-gray-200 p-2 rounded-lg cursor-pointer">
          <img
            width="30"
          ...
          />
          <span className="my-auto ml-2 font-bold"> Live </span>
        </li>
<li className="flex m-4 hover:bg-gray-200 p-2 rounded-lg cursor-pointer">
          <img
            width="30"
          ...
          />
          <span className="my-auto ml-2 font-bold"> Gaming </span>
        </li>
<li className="flex m-4 hover:bg-gray-200 p-2 rounded-lg cursor-pointer">
          <img
            width="30"
          ...
          />
          <span className="my-auto ml-2 font-bold"> News </span>
        </li>
<li className="flex m-4 hover:bg-gray-200 p-2 rounded-lg cursor-pointer">
          <img
            width="30"
          ...
          />
          <span className="my-auto ml-2 font-bold"> Sports </span>
        </li>
<li className="flex m-4 hover:bg-gray-200 p-2 rounded-lg cursor-pointer">
          <img
            width="30"
          ...
          />
          <span className="my-auto ml-2 font-bold"> Learning </span>
        </li>
<li className="flex m-4 hover:bg-gray-200 p-2 rounded-lg cursor-pointer">
          <img
            width="30"
          ...
          />
          <span className="my-auto ml-2 font-bold"> Fashion & Beauty </span>
        </li>
<li className="flex m-4 hover:bg-gray-200 p-2 rounded-lg cursor-pointer">
          <img
            width="30"
          ...
          />
          <span className="my-auto ml-2 font-bold"> Podcasts </span>
        </li>
      </ul>
    </div>
  );
